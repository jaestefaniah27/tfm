...
ancladas a la frase exacta, para que Claude Code las aplique después sobre el
LaTeX.
...
Abre una sesión de Claude Code en el servidor, con las herramientas MCP que dan
