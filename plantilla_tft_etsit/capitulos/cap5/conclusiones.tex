...
Se diseñaron y fabricaron \textbf{tres} tarjetas de circuito impreso, todas ellas en el propio
laboratorio mediante proceso de soldadura por reflujo con \textit{stencil}. Las dos que responden
a especificación externa ---la placa CDHS y la placa AOCS--- cumplen los requisitos impuestos por
Indra a través de Sener y han permitido validar el sistema de comunicaciones en un entorno
hardware real.

La placa de comunicación serie, con sus catorce transceptores
RS-485/RS-422, se caracterizó eléctricamente con una batería de nueve tests que
