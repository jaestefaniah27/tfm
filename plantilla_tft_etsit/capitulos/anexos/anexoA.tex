...
modificarse y volver a sintetizarse sin depender de licencias ni de autorizaciones externas.

Un programa de este tipo persigue empleo cualificado y no empleo genérico. Un ingeniero que diseña
y verifica un transceptor añade mucho más valor por hora de trabajo que quien ensambla un producto
ya definido por otro proveedor. Ese valor añadido es exportable a otros proyectos. El conocimiento
adquirido, por ejemplo cómo se sintetiza un puente VHDL o cómo se caracteriza un driver serie a
alta velocidad, permanece en el país aunque cambie el contratista. Comprar el mismo subsistema a un
proveedor externo no deja detrás ese conocimiento.

Generar ese empleo cualificado no es inmediato. Exige años de preparación y, sobre todo,
experiencia en programas reales, que solo se adquiere participando en misiones. Sin misiones en
marcha no hay dónde formar a ese personal. Retenerlo después no es más sencillo. El perfil es
internacionalmente móvil. Compite con fabricantes y agencias de países con industria espacial
consolidada, y con el sector tecnológico civil, que no exige los mismos plazos de cualificación.
Sin continuidad de proyectos en España, el resultado habitual es la fuga de titulados hacia esos
otros destinos.

Un programa como el PERTE Aeroespacial no busca sostener esa plantilla de forma indefinida con
fondos públicos. Busca alcanzar una masa crítica de empresas y de personal cualificado que sostenga
una cadena de suministro nacional. Esa masa crítica permite que la industria se sostenga después
por contratos comerciales, sin depender de la siguiente convocatoria. Es la autonomía estratégica
declarada al inicio de este apartado: una industria que deja de necesitar la subvención pública.

Un trabajo de fin de máster desarrollado dentro de un programa de este tipo es precisamente el
mecanismo por el que se forma ese personal. Aplica conocimiento académico a un problema real, con
las restricciones y los plazos de una misión concreta, y deja como resultado a alguien capacitado
para seguir trabajando en el sector.
