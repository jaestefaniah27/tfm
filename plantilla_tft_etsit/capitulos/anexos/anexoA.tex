...
endurecidas para espacio. Esto reduce el coste y el plazo, pero acorta la vida útil esperada del
...
\section{Análisis detallado de alguno de los impactos}
\normalsize{%
...
comparativa del capítulo~\ref{cap:resultados} permite calcular esa magnitud, porque mide sobre el mismo dispositivo,
