...
el detalle de la aplicación de testing del driver serie y los volcados completos del terminal de las pruebas de validación hardware del Capítulo~4.
...
\section*{C.8 Volcados completos de terminal de las pruebas serie RS422/RS485}
...
\subsection*{C.8.1 Placa CDHS (3 transceptores)}
...
\subsection*{C.8.2 Placa AOCS (5 transceptores)}
...
\section*{C.9 Volcado completo del barrido del ADC}
