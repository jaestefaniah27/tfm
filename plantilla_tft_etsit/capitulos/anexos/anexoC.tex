...
el detalle de la aplicación de testing del driver serie, el procedimiento completo del ejemplo
de validación del flujo de desarrollo y los volcados completos del terminal de las pruebas de
validación hardware del Capítulo~4.
...
\section*{C.7 Aplicación de testing del driver serie en RTEMS}
...
\subsection*{C.7.1 Configuración del sistema --- \texttt{init.c}}
...
\subsection*{C.7.2 Aplicación --- \texttt{main.c}}
...
\section*{C.8 Flujo de desarrollo de extremo a extremo: ejemplo de la puerta AND}
...
\subsection*{C.8.1 Descripción VHDL y \textit{Block Design}}
...
\subsection*{C.8.2 Generación de la imagen de arranque en Vitis}
...
\subsection*{C.8.3 Aplicación de RTEMS y arranque desde la tarjeta SD}
...
\subsection*{C.8.4 Barrido de la tabla de verdad}
...
\section*{C.9 Volcados completos de terminal de las pruebas serie RS422/RS485}
...
\subsection*{C.9.1 Placa CDHS (3 transceptores)}
...
\subsection*{C.9.2 Placa AOCS (5 transceptores)}
...
\section*{C.10 Volcado completo del barrido del ADC}
