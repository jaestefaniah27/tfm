...
por el NCO del transceptor serie junto con su error medido, y el recuento del código desarrollado
a lo largo del trabajo.

\section*{A.1 Mapa de señales LINCE Comunicación Serial}
...
\section*{A.2 Mapa de señales CDHS}
...
\section*{A.3 Mapa de señales AOCS}
...
\section*{A.4 Tabla de frecuencias del NCO}
...
\texttt{tb\_NCO.vhd}, que son las del rango de uso previsto (de 9600 a 3,6864~Mbaudios): para cada
...
entradas por debajo de 9600~baudios quedan fuera del uso previsto y la de 4~Mbaudios exige un
...
\begin{table}[H]
    ...
    \begin{tabular}{rrrrrr}
        ...
        \hline
    \end{tabular}
    \caption{Tabla NCO: las 29 velocidades del rango de uso ejercitadas en simulación, con sus
    incrementos de síntesis y el error medido (modo \textit{full-bit}).}
    \label{tab:nco}
\end{table}

\section*{A.5 Volumen y distribución del código desarrollado}
