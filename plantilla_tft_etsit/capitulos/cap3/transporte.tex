...
dos ejes. En \textbf{coste de CPU} la variante GPIO queda descartada por sí sola: sus 1\,250
interrupciones por kilobyte la mantienen en \textit{livelock} y su rendimiento no mejora al subir
la velocidad de línea. Las dos variantes con DMA resuelven ese problema por igual, hasta 3
interrupciones por kilobyte en transmisión, de modo que la diferencia entre ellas no está en lo
que rinden sino en lo que cuestan.

Ahí la comparación es concluyente. Replicar catorce motores cuesta \textbf{2,8 veces} la lógica de
compartir uno solo, 2\,873 frente a 1\,014 LUT por canal para el mismo número de canales, y esa
distancia se triplica en cuanto se plantee el endurecimiento por TMR: la variante DMA14 llevaría
cerca de la mitad del dispositivo, mientras que la multicanal sigue siendo asumible. En
interrupciones la diferencia no es de grado sino cualitativa, porque veintiocho líneas contra las
ocho disponibles obligan a reducirlas por OR y a escanear catorce registros de estado en cada
evento, mientras que tres líneas caben con holgura.
