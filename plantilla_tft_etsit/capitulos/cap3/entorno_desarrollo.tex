...
\begin{itemize}
    ...
    de temporización de bit para las 54 velocidades soportadas, para que transmisor y
...
tiempo de arranque, para que el mismo binario funcione con cualquier número de
