...
\begin{sidewaysfigure}
    \centering
    \includegraphics[width=0.95\textheight, page=1]{IMG/pcbs/LINCE3_SERIAL.pdf}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[width=0.95\textheight, page=1]{IMG/pcbs/LINCE3_AOCS_V2.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{IMG/Desarrollo/diagrama_arnes_loopback.pdf}
