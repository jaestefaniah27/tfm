...
(disponible en \texttt{tfm/06\_firmware/boot\_scripts/}), un \textit{wizard} interactivo en Bash que encadena todos
...
y las BOM de las tres placas están disponibles en el repositorio del proyecto bajo
...
criterio, igual que el transceptor \texttt{THVD1424RGTR} de los canales serie, elegido por soportar
\textit{VIO} de 1,8~V de forma nativa.
