...
La ZCU102 es una tarjeta de evaluación de propósito general de Xilinx (hoy AMD) para el prototipado de
...
El bus CAN (\textit{Controller Area Network}) nació en automoción y se usa como estándar de facto
