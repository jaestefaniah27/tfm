...
\textit{Data}, lo que elimina la necesidad de un alineamiento estricto de reloj y proporciona una
alta tolerancia al desfase (\textit{skew}) entre pares~\cite{ecss50spw,parkes2012spw}. Proporciona
enlaces punto a punto \textit{full-duplex} asíncronos de hasta 400~Mbps. Su pila incluye una capa de
red que permite encaminar paquetes a través de \textit{routers} SpaceWire~\cite{ecss50spw,parkes2012spw}.
