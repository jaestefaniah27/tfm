...
del capítulo~4. La figura~\ref{fig:mpsoc_zynq_amd} añade el detalle interno de cada dominio tal y
como lo documenta el fabricante.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{IMG/Desarrollo/diagrama_mpsoc_zynq_oficial.jpg}
    \caption{Arquitectura del MPSoC Zynq UltraScale+ (fuente: AMD).}
    \label{fig:mpsoc_zynq_amd}
\end{figure}
...
alta tolerancia al desfase (\textit{skew}) entre pares. El estándar define enlaces punto a punto
