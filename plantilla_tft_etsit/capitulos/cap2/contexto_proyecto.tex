...
los extremos del bus para evitar reflexiones~\cite{ti2014rs485,eia485a}.

\subsection{RS422}

El estándar TIA/EIA-422 (RS422) comparte con el RS485 la señalización diferencial, pero no la
topología: está pensado para enlaces punto a punto o \textit{multi-drop}, con un único transmisor
...
En el nivel físico usa señalización LVDS y una codificación \textit{Data-Strobe}: en lugar de
transmitir un reloj aparte, que a alta frecuencia se desalinearía respecto a los datos
(\textit{skew}), envía los datos por un par y una señal \textit{strobe} por otro, de modo que el
...
Es multipunto y multimaestro, con acceso por escucha de portadora y arbitraje por prioridad de
...
detección de errores por hardware (CRC, \textit{bit stuffing}, comprobación de trama) y
