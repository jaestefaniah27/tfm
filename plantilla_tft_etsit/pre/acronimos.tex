...
\paragraph{GPIO} \textit{General Purpose Input/Output} --- Puerto de entrada/salida de propósito general; da nombre a la primera arquitectura de transporte comparada.
