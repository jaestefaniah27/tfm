...
\paragraph{COTS} \textit{Commercial Off-The-Shelf} --- Componente comercial de catálogo.
...
\paragraph{VIO} Tensión de alimentación del banco de entrada/salida digital de un circuito integrado, independiente de la de su núcleo; fija los niveles lógicos que la pieza acepta y entrega en sus pines.
