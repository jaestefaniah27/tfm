...
% ===================== Sprint =====================
\draw[blk] (4.60,3.90) rectangle (13.00,9.10);
\node[align=center] at (8.80,8.55) {Sprint --- 2 semanas};

% Las tres columnas caben con 0,20 cm de margen a cada lado del recuadro azul:
% con 2,50 de ancho la de Hecho se salia por la derecha.
\foreach \x/\t/\n in {5.00/Pendiente/2, 7.70/{En curso}/1, 10.40/Hecho/2} {
    \draw[ip] (\x,4.25) rectangle (\x+2.40,7.55);
    \node[lbl] at (\x+1.20,7.20) {\t};
    \foreach \i in {1,...,\n} {
        \draw[card] (\x+0.20,3.65+0.80*\i)
              rectangle (\x+2.20,4.20+0.80*\i);
    }
}
\node[note] at (8.80,7.90) {tablero tipo Kanban (Jira)};

% ===================== Reunión de cierre =====================
\draw[blk] (4.60,0.20) rectangle (13.00,3.10);
\node[align=center] at (8.80,2.72) {Reunión de cierre};
...
\draw[sig] (8.80,3.90) -- (8.80,3.10);

% ===================== Realimentación: cierra el lazo =====================
\draw[sig] (8.80,0.20) -- (8.80,-0.75) -- (1.50,-0.75) -- (1.50,3.90);
