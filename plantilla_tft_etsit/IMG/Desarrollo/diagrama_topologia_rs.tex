...
\begin{tikzpicture}[
    ...
    tlbl/.style={font=\ttfamily\small, inner sep=2pt},
...
% Cajas más anchas que las del maestro: «Esclavo(s)» no cabía en 1,6 cm.
\draw[ext] (13.25,1.55) rectangle (15.55,5.55);
\draw[ext, fill=cExt!10] (13.1,1.7) rectangle (15.4,5.7);
\node[lbl] at (14.25,3.7) {Esclavo(s)};
\node[tlbl] at (14.25,5.35) {RX};
\node[tlbl] at (14.25,2.05) {TX};

% ----- Par de ida: TX del maestro -> RX del/de los esclavo(s) -----
\draw[cRef!85!black, line width=1.1pt] (2.8,5.2) -- (13.1,5.2);
\draw[cRef!85!black, line width=1.1pt] (2.8,4.6) -- (13.1,4.6);
...
\draw[res] (12.8,4.6) rectangle (13.1,5.2);
\node[lbl, anchor=north east, text=cRef!45!black] at (12.65,4.45) {120~$\Omega$};

% ----- Par de vuelta: TX del/de los esclavo(s) -> RX del maestro -----
\draw[cRef!85!black, line width=1.1pt] (2.8,2.6) -- (13.1,2.6);
\draw[cRef!85!black, line width=1.1pt] (2.8,2.0) -- (13.1,2.0);
