...
\tikzset{
    ...
    rot/.style   ={font=\sffamily\small, text=cRef!45!black, inner sep=2pt},
}
\newcommand{\sub}[1]{{\footnotesize\textcolor{cRef!30!black}{#1}}}
...
\node[ext, minimum width=2.6cm, minimum height=2.4cm] (pl) at (12.6,0)
     {perif\'erico\\(PL)};
