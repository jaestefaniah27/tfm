...
entity TX_CONFIGURABLE_SERIAL is
    generic (
        -- Ciclos de settling de DE antes (PreDE) y después (PostDE) de la trama.
        -- 10000 = 100us @100MHz (valor real). En simulación se baja a ~16 para
        -- acelerar; NO afecta a la síntesis si se deja el default.
...
architecture Behavioral of TX_CONFIGURABLE_SERIAL is
  ...
  component NCO
    ...
    -- Counter de Delay para el settling de DE (DELAY_CYCLES es ahora generic)
