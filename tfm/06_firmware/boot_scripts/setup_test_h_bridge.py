...
print("=" * 55)
print("  Vitis: platform_test_h_bridge + fsbl_test_h_bridge")
print("=" * 55)
...
print()
print("[1/5] Creando plataforma 'platform_test_h_bridge'...")
advanced_options = client.create_advanced_options_dict(dt_overlay="0")
platform = client.create_platform_component(
    name="platform_test_h_bridge",
    hw_design="/home/mpsocv2/vivado_aocs/vivado_aocs/vivado_aocs_wrapper.xsa",
    os="standalone",
    cpu="psu_cortexa53_0",
...
platform = client.get_component(name="platform_test_h_bridge")
...
print()
print("[4/5] Creando aplicación FSBL 'fsbl_test_h_bridge'...")
comp = client.create_app_component(
    name="fsbl_test_h_bridge",
    platform="/home/mpsocv2/vitis_cdhs/platform_test_h_bridge/export/platform_test_h_bridge/platform_test_h_bridge.xpfm",
    domain="fsbl_domain",
...
comp = client.get_component(name="fsbl_test_h_bridge")
comp.build()
