...
print("=" * 55)
print("  Vitis: platform_full_cdhs_delay + fsbl_full_cdhs_delay")
print("=" * 55)
...
print()
print("[1/5] Creando plataforma 'platform_full_cdhs_delay'...")
advanced_options = client.create_advanced_options_dict(dt_overlay="0")
platform = client.create_platform_component(
    name="platform_full_cdhs_delay",
...
platform = client.get_component(name="platform_full_cdhs_delay")
...
print()
print("[4/5] Creando aplicación FSBL 'fsbl_full_cdhs_delay'...")
comp = client.create_app_component(
    name="fsbl_full_cdhs_delay",
    platform="/home/mpsocv2/vitis_cdhs/platform_full_cdhs_delay/export/platform_full_cdhs_delay/platform_full_cdhs_delay.xpfm",
    domain="fsbl_domain",
...
comp = client.get_component(name="fsbl_full_cdhs_delay")
comp.build()
