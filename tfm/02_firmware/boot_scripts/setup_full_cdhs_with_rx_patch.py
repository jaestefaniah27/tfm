...
print("=" * 55)
print("  Vitis: platform_full_cdhs_with_rx_patch + fsbl_full_cdhs_with_rx_patch")
print("=" * 55)
...
print()
print("[1/5] Creando plataforma 'platform_full_cdhs_with_rx_patch'...")
advanced_options = client.create_advanced_options_dict(dt_overlay="0")
platform = client.create_platform_component(
    name="platform_full_cdhs_with_rx_patch",
...
platform = client.get_component(name="platform_full_cdhs_with_rx_patch")
...
print()
print("[4/5] Creando aplicación FSBL 'fsbl_full_cdhs_with_rx_patch'...")
comp = client.create_app_component(
    name="fsbl_full_cdhs_with_rx_patch",
    platform="/home/mpsocv2/vitis_cdhs/platform_full_cdhs_with_rx_patch/export/platform_full_cdhs_with_rx_patch/platform_full_cdhs_with_rx_patch.xpfm",
    domain="fsbl_domain",
...
comp = client.get_component(name="fsbl_full_cdhs_with_rx_patch")
comp.build()
