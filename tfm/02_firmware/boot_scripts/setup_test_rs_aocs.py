...
print("=" * 55)
print("  Vitis: platform_test_rs_aocs + fsbl_test_rs_aocs")
print("=" * 55)
...
print()
print("[1/5] Creando plataforma 'platform_test_rs_aocs'...")
advanced_options = client.create_advanced_options_dict(dt_overlay="0")
platform = client.create_platform_component(
    name="platform_test_rs_aocs",
...
platform = client.get_component(name="platform_test_rs_aocs")
...
print()
print("[4/5] Creando aplicación FSBL 'fsbl_test_rs_aocs'...")
comp = client.create_app_component(
    name="fsbl_test_rs_aocs",
    platform="/home/mpsocv2/vitis_cdhs/platform_test_rs_aocs/export/platform_test_rs_aocs/platform_test_rs_aocs.xpfm",
    domain="fsbl_domain",
...
comp = client.get_component(name="fsbl_test_rs_aocs")
comp.build()
