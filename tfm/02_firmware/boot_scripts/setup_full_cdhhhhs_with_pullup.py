...
print("=" * 55)
print("  Vitis: platform_full_cdhhhhs_with_pullup + fsbl_full_cdhhhhs_with_pullup")
print("=" * 55)
...
print()
print("[1/5] Creando plataforma 'platform_full_cdhhhhs_with_pullup'...")
advanced_options = client.create_advanced_options_dict(dt_overlay="0")
platform = client.create_platform_component(
    name="platform_full_cdhhhhs_with_pullup",
...
platform = client.get_component(name="platform_full_cdhhhhs_with_pullup")
...
print()
print("[4/5] Creando aplicación FSBL 'fsbl_full_cdhhhhs_with_pullup'...")
comp = client.create_app_component(
    name="fsbl_full_cdhhhhs_with_pullup",
    platform="/home/mpsocv2/vitis_cdhs/platform_full_cdhhhhs_with_pullup/export/platform_full_cdhhhhs_with_pullup/platform_full_cdhhhhs_with_pullup.xpfm",
    domain="fsbl_domain",
...
comp = client.get_component(name="fsbl_full_cdhhhhs_with_pullup")
comp.build()
